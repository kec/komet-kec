 ...
 */
public sealed interface KlListArea<LE, OL extends ObservableList<LE>, FX extends Region>
        extends KlPropertyArea<OL, FX>
        permits KlListOfFeatureArea {
     ...
     */
    non-sealed interface Factory<LE, OL extends ObservableList<LE>, FX extends Region, KL extends KlListArea<LE, OL, FX>>
            extends KlPropertyArea.Factory<OL, FX, KL> {
    }
}
