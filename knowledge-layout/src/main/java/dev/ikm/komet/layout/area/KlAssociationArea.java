 ...
 */
    ...
    non-sealed interface Factory<FX extends Region, KL extends KlAssociationArea<FX>> extends KlArea.Factory<FX, KL> {

        /**
         * Retrieves the compatible service type names for the area factory. These types can
