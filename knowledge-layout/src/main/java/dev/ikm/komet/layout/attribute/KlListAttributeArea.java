 ...
 */
public sealed interface KlListAttributeArea<DT extends ObservableList<LE>, LE, FX extends Region>
        extends KlAttributeArea<DT, FX>
        permits KlListOfAttributeDefinitionArea, KlListOfAttributeArea, KlListOfVersionsAttributeArea {
