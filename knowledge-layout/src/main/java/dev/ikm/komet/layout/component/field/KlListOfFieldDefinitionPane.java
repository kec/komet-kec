 ...
 * This interface extends {@link KlListFieldPane}, parameterized to support a list of
 ...
 * @param <FX> the type of the parent UI element associated with this pane; must extend {@link Parent}
 */
public non-sealed interface KlListOfFieldDefinitionPane<L extends List<DT>, DT extends FieldDefinition, FX extends Parent>
        extends KlListFieldPane<L, DT, FX> {
}
