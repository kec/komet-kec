 ...
 */
public non-sealed interface KlListOfAttributeDefinitionArea<DT extends ObservableList<LE>, LE extends FieldDefinition, FX extends Region>
        extends KlListAttributeArea<DT, LE, FX> {
}
