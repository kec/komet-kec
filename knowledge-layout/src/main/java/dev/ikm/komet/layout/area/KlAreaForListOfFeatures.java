...
public sealed interface KlAreaForListOfFeatures<F extends Feature<?>, FX extends Region>
    ...
    default void setAreaFeatureListKey(FeatureKey areaFeatureListKey) {
        preferences().putObject(KlAreaForListOfFeatures.PreferenceKeys.AREA_FEATURE_LIST_KEY, areaFeatureListKey);
    }

    default ImmutableList<FeatureKey> getSelectedFeatureKeys() {
        if (preferences().hasKey(KlAreaForListOfFeatures.PreferenceKeys.SELECTED_FEATURES_KEY)) {
            Optional<Selection> selectedFeatures = preferences().getObject(KlAreaForListOfFeatures.PreferenceKeys.SELECTED_FEATURES_KEY);
    ...
    default void setSelectedFeatureKeys(ImmutableList<FeatureKey> selectedFeatureKeys) {
        ...
        preferences().putObject(KlAreaForListOfFeatures.PreferenceKeys.SELECTED_FEATURES_KEY, selection);
    }
