 ...
 */
public non-sealed interface KlGenericComponentPaneFactory<FX extends Pane>
        extends KlComponentPaneFactory<FX, KlComponentPane<ObservableEntity, FX>, ObservableEntity> {
}
