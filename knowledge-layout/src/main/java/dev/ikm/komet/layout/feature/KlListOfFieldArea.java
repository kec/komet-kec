 ...
 * {@link KlListOfFeatureArea} to specifically work with {@link ObservableField} components and
...
public non-sealed interface KlListOfFieldArea<FX extends Region>
        extends KlListOfFeatureArea<ObservableField<?>, FX>, ClassConceptBinding {
    ...
    interface Factory<FX extends Region>
            extends KlListOfFeatureArea.Factory<ObservableField<?>, FX, KlListOfFieldArea<FX>> {
