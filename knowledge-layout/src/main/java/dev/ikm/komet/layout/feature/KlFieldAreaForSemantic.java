 ...
 */
@FullyQualifiedName("Knowledge layout semantic field area")
@RegularName("Semantic field area")
@ParentConcept(KlFieldArea.class)
public non-sealed interface KlFieldAreaForSemantic<FX extends Region>
        extends KlFieldArea<SemanticFacade, FX> {
    ...
    interface Factory<FX extends Region>
            extends KlFieldArea.Factory<SemanticFacade, FX, KlFieldAreaForSemantic<FX>> {
    }
}
