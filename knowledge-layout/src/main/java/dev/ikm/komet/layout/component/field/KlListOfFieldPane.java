 ...
 * @param <FX> the type of the parent UI element associated with this pane, extending {@code Parent}
 */
public non-sealed interface KlListOfFieldPane<L extends List<DT>, DT extends Field<DT>, FX extends Parent>
