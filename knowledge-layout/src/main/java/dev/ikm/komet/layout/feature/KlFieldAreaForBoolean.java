...
public non-sealed interface KlFieldAreaForBoolean<FX extends Region>
        extends KlFieldArea<Boolean, FX> {

    /**
     * Represents a factory interface for creating and managing instances of
     * {@link KlFieldAreaForBoolean}, which are specialized field areas in the
    ...
    interface Factory<FX extends Region>
            extends KlFieldArea.Factory<Boolean, FX, KlFieldAreaForBoolean<FX>> {
    }
}
