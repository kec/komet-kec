 ...
 */
public non-sealed interface KlListOfVersionArea<FX extends Region>
        extends KlListOfFeatureArea<Feature<ObservableVersion>, FX> {
    /**
     ...
     */
    record VersionsAndSelection(ImmutableList<Feature<ObservableVersion>> versions,
                                ImmutableList<Feature<ObservableVersion>> selectedVersions) {
         ...
         */
        public VersionsAndSelection(ObservableList<Feature<ObservableVersion>> observableVersions,
                                    ObservableList<Feature<ObservableVersion>> observableSelectedVersions) {
    ...
    interface Factory<FX extends Region>
            extends KlListOfFeatureArea.Factory<Feature<ObservableVersion>, FX, KlListOfVersionArea<FX>> {
