 ...
 * {@link KlAttributeArea}, parameterized with {@code Boolean}, and provides mechanisms
 ...
 */
public non-sealed interface KlBooleanAttributeArea<FX extends Region> extends KlAttributeArea<Boolean, FX> {
