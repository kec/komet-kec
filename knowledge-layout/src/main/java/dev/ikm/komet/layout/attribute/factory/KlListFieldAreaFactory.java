...
/**
 * Represents a factory interface for creating and managing instances of {@link KlAttributeArea}
...
public interface KlListFieldAreaFactory<LE, FX extends Region> extends
        KlFieldAreaFactory<ObservableList<LE>, FX, KlAttributeArea<ObservableList<LE>, FX>> {
}
