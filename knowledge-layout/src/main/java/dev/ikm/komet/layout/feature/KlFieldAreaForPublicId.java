...
public non-sealed interface KlFieldAreaForPublicId<FX extends Region>
        extends KlFieldArea<PublicId, FX> {
    ...
    interface Factory<FX extends Region>
            extends KlFieldArea.Factory<PublicId, FX,
            KlFieldAreaForPublicId<FX>> {
    }
}
