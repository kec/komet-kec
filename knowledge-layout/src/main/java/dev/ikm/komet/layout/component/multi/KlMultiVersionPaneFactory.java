...
/**
 * A factory interface for creating instances of {@link KlMultiVersionPane}, a component designed to handle
 ...
 */
public interface KlMultiVersionPaneFactory<OV extends ObservableVersion, P extends Pane>
        extends KlFactory<KlWidget>, KlVersionType<OV> {

    /**
     * Creates an instance of {@link KlMultiVersionPane}, which is a component for managing and visually
     ...
     * @return a new instance of {@link KlMultiVersionPane} configured with the given observable versions, view, and preferences
     */
    KlMultiVersionPane<OV, P> create(ImmutableList<OV> observableVersions,
