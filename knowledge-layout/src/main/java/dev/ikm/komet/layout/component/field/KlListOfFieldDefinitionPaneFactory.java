...
/**
 * Represents a factory interface for creating instances of {@link KlListFieldPane},
 ...
 * <p>
 * This interface extends {@link KlListFieldPaneFactory}, inheriting its type-safe
 ...
 * @param <FX> the type of the parent UI element associated with the pane, extending {@link Pane}
 */
public interface KlListOfFieldDefinitionPaneFactory<DT extends FieldDefinition, L extends List<DT>, FX extends Pane>
