 ...
 * {@link KlFieldPane}, parameterized with a list data structure, enabling support for a
 ...
 * @param <FX> the type of the parent UI element associated with this pane, extending {@link Parent}
 */
public sealed interface KlListFieldPane<L extends List<DT>, DT, FX extends Parent> extends KlFieldPane<L, FX>
        permits KlListOfFieldDefinitionPane, KlListOfFieldPane, KlListOfVersionsFieldPane {
}
