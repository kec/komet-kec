...
public class FieldCategorySet extends ImmutableEnumSet<FieldCategory> {
    ...
    private static final FieldCategorySet COMPONENT_FIELDS = new FieldCategorySet(PUBLIC_ID_FIELD, COMPONENT_VERSIONS_FIELD);
    ...
    private static final FieldCategorySet SEMANTIC_FIELDS = new FieldCategorySet(PUBLIC_ID_FIELD, SEMANTIC_PATTERN_FIELD, SEMANTIC_REFERENCED_COMPONENT_FIELD, COMPONENT_VERSIONS_FIELD);
